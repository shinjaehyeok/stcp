...
plot(1:max_sample, log_e_val_vec, type = "l", 
     xlab = "n", ylab = "e-value")
...
plot(1:max_sample, log_e_val_vec, type = "l",
     xlim = c(0, max_sample),
     ylim = c(min(log_e_val_vec), max(single_SR$log_mix_e_detect_val)),
...
plot(1:max_sample, log_mix_e_val_vec, type = "l", 
     xlab = "n", ylab = "e-value")
...
plot(1:max_sample, log_mix_e_val_vec, type = "l",
     xlab = "n", ylab = "log e-val", main = paste0("v = ", v),
     xlim = c(0, max_sample),
     ylim = c(min(log_e_val_vec), max(mix_SR$log_mix_e_detect_val)))
lines(1:max_sample, log_e_val_vec, type = "l", lty = 2)
