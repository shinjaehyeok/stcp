...
stcp is a prototyped R package built to run nonparametric sequential tests and
online change point detection algorithms in [SRR 21'](https://arxiv.org/abs/2010.08082) and [SRR 23'](https://arxiv.org/abs/2203.03532). For more efficient implementations with a limited scope, please use [`stcpR6`]((https://github.com/shinjaehyeok/stcpR6)) package.
